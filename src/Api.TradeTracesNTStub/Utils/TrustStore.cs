...
namespace Api.TradeTracesNTStub.Utils;
...
public static class TrustStore
{
    ...
    private static void AddCertificates(List<string> certificates)
    {
        ...
        var x509Certificate2S = certificates.Select(cert => X509CertificateLoader.LoadCertificate(Encoding.ASCII.GetBytes(cert)));
