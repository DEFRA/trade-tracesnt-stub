...
public static class WireMockServerOrganicOperatorExtensions
{
    public static WireMockServer CreateOrganicOperatorStubs(this WireMockServer server)
    {
        server
            ...
            .AtPriority(2)
            .RespondWith(Response.Create().WithCallback(async _ => await SoapUtils.CreateResponseFromResource(HttpStatusCode.OK, "Api.TradeTracesNTStub.Mock.Samples.ORGANIC_OPERATOR.GetOrganicOperatorResponse.xml")));
        ...
        server
            ...
            .AtPriority(2)
            .RespondWith(Response.Create().WithCallback(async _ => await SoapUtils.CreateResponseFromResource(HttpStatusCode.OK, "Api.TradeTracesNTStub.Mock.Samples.ORGANIC_OPERATOR.FindOrganicOperatorResponse.xml")));
