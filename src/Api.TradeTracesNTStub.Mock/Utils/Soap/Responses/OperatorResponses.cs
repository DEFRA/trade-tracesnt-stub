...
public static class OperatorResponses
{
    ...
    {
        var resourceContent = await SoapUtils.GetEmbeddedResource("Api.TradeTracesNTStub.Mock.Samples.OPERATOR.Operator.Created.TEMPLATE.xml");
    ...
    {
        var resourceContent = await SoapUtils.GetEmbeddedResource("Api.TradeTracesNTStub.Mock.Samples.OPERATOR.GetOperatorByIdResponse.TEMPLATE.xml");
