...
public static class CertificateAttachmentResponses
{
    ...
    {
        var resourceContent = await SoapUtils.GetEmbeddedResource("Api.TradeTracesNTStub.Mock.Samples.CERTIFICATE_ATTACHMENT.SubmitCertificateAttachmentResponse.TEMPLATE.xml");
    ...
    {
        var resourceContent = await SoapUtils.GetEmbeddedResource("Api.TradeTracesNTStub.Mock.Samples.CERTIFICATE_ATTACHMENT.GetCertificateAttachmentResponse.TEMPLATE.xml");
